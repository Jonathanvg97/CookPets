    ...
    <>
      ...
      <div className="All">
        <ul className="Categories">
          <button className="bt"onClick={(_) => setData(products)}>
            <li className="Todos">Todos</li>
          </button>
          <button className="bt" onClick={(_) => filterResult("Tortas")}>
            <li>Tortas</li>
          </button>
          <button className="bt" onClick={(_) => filterResult("Snacks")}>
            <li>Snacks</li>
          </button>
          <button className="bt" onClick={(_) => filterResult("Birthday")}>
            <li>Tortas CumplePet</li>
          </button>
          <button className="bt" onClick={(_) => filterResult("Planes y Promociones")}>
        ...
        {data.map((product) => {
          return (
            <>
              ...
              <img className="card-img" src={product.url} alt="Imagenes Productos" />
